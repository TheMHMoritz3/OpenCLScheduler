...
\begin{frame}
   ...
   \begin{enumerate}
	\item Enable different schedules for different devices - done
	\item Add ASAP Scheduling
	\item Add Dynamic Scheduling
	\item Add auto generated diagrams, within the software
   \end{enumerate}
\end{frame}
\end{document}
