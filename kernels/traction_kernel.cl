 ...
 */
__kernel void tractionControl(global const float* speedF, global const float* speedRL, global const float* speedRR, global const float* threshold, global int* result, const int wLoad){
