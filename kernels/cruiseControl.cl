__kernel void cruiseControl(global const float* accelSensor, global const float* wSpeedmedian, global const int* targetLimit, global float* result, const int WLOAD) {
