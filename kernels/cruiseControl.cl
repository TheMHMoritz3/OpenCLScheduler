__kernel void cruiseControl(global const int* targetLimit, global const float* accelSensor, global const float* wSpeedmedian, global float* result, const int WLOAD) {
