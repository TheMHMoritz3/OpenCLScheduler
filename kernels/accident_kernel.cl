 ...
 */
__kernel void accidentConst(global const float* input, const int min, const int max, global int* result, const int wLoad) {
 ...
 */
__kernel void accidentPeak(global const float* input, const int min, const int max, global int* result, const int wLoad) {
    int gid = get_global_id(0) * wLoad;
